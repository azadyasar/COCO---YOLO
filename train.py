...
wdir = '/home/ec2-user/weights' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/home/ec2-user/coco.data', help='*.data path')
    ...
    parser.add_argument('--weights', type=str, default='ultralytics68.pt', help='initial weights')
